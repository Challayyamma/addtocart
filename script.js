...
const loadProducts = () => {
    ...
    productsContainer.innerHTML = `
        ...
        <div class="col-md-4 mb-4 placeholder">
            <img class="img-fluid" src="placeholder.jpg" alt="placeholder image">
        </div>
        <div class="col-md-4 mb-4 placeholder">
            <img class="img-fluid" src="placeholder.jpg" alt="placeholder image">
        </div>
...
const showProducts = (products) => {
    ...
    for (const product of allProducts) {
        ...
        div.innerHTML = `
            <div class="card mb-4">
                <img src="${product.image ? product.image : `image_not_found.png`}" class="card-img-top img-fluid p-4 border-bottom" alt="${product.title}">
                <div class="card-body">
